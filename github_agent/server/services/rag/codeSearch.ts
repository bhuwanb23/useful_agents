...
export class CodeSearch {
  async findDefinition(functionName: string, repoId: number): Promise<SearchResult[]> {
  ...
  async findUsages(variableName: string, repoId: number): Promise<SearchResult[]> {
  ...
  async findRelevantContext(issueDescription: string, repoId: number, limit: number = 5): Promise<SearchResult[]> {
  ...
  async findSimilarCode(codeSnippet: string, repoId: number, limit: number = 5): Promise<SearchResult[]> {
  ...
  async buildContextForIssue(issueId: number): Promise<{ context: string; sources: SearchResult[] }> {
